      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden select-none">
        ...
        <div
          ...
          className={`shrink-0 flex flex-col overflow-hidden transition-[width,flex-basis] duration-100 ease-out border-r border-[#E0E0E0] ${
            mobileView === 'editor' ? 'flex h-[calc(100dvh-170px)]' : 'hidden md:flex h-[calc(100dvh-160px)] md:h-[calc(100vh-160px)]'
          }`}
        >
        ...
        <div
          className={`flex-1 flex flex-col h-[calc(100dvh-170px)] md:h-[calc(100vh-160px)] overflow-hidden bg-[#F1F3F6] ${
            mobileView === 'editor' ? 'hidden md:flex' : 'flex'
          }`}
        >
          {/* Main Visualizer Navigation Tabs & Collapse Control */}
          <div className={`h-11 px-3 bg-white border-b border-[#E0E0E0] items-center justify-between gap-1 overflow-x-auto touch-pan-x select-none shrink-0 ${
          ...
          <div className={`p-3 overflow-y-auto space-y-4 ${
            mobileView === 'telemetry' ? 'hidden md:block flex-1' : 'flex-1'
          }`}>
          ...
          >
            ...
            <div className={`p-2.5 overflow-y-auto bg-[#F1F3F6] ${
              mobileView === 'telemetry' ? 'flex-1 min-h-0' : 'max-h-52'
            }`}>
