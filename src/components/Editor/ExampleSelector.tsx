...
export const ExampleSelector: React.FC = () => {
  ...
  return (
    <div className="relative shrink-0">
      <div className="flex items-center gap-1.5 px-2 sm:px-2.5 py-1.5 rounded-lg bg-white text-[#212121] text-xs shadow-xs border border-white/40 hover:border-white transition-all">
        ...
        <select
          ...
          className="bg-transparent text-xs text-[#212121] font-semibold focus:outline-none cursor-pointer pr-1 max-w-[110px] sm:max-w-[150px] md:max-w-[180px] lg:max-w-[210px] truncate"
        >
